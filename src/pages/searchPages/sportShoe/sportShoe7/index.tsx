...
const SportShoe7 = () => {
    ...
    let userShop = {
        ...
        item: '361篮球鞋big3阿隆戈登运动鞋Q弹男鞋夏季361°实战网面透气球鞋',
        priceSum: Math.floor(count*279*1000)/1000,
        count: count,
        price: 279,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/i4/363607599/O1CN01DouWTg260OSJASHdU-363607599.jpg_580x580Q90.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*279*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/i4/363607599/O1CN01DouWTg260OSJASHdU-363607599.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>361篮球鞋big3阿隆戈登运动鞋Q弹男鞋夏季361°实战网面透气球鞋</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥279.00</span>
                    </div>
