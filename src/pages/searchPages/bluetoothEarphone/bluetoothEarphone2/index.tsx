...
const BluetoothEarphone2 = () => {
    ...
    let userShop = {
        ...
        item: 'JBL C260TWS蓝牙耳机无线音乐原装长待机续航立体声通话入耳式',
        priceSum: Math.floor(count*149*1000)/1000,
        count: count,
        price: 149,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i4/1640690073/O1CN01MMlGHE1CPTfEj3JpV_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i4/1640690073/O1CN01MMlGHE1CPTfEj3JpV_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>JBL C260TWS蓝牙耳机无线音乐原装长待机续航立体声通话入耳式</h2>
...
export default BluetoothEarphone2;