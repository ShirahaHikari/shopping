...
const BluetoothEarphone8 = () => {
    ...
    let userShop = {
        ...
        item: 'Apple AirPods Pro 蓝牙耳机',
        priceSum: Math.floor(count*1999*1000)/1000,
        count: count,
        price: 1999,
        img:'https://g-search2.alicdn.com/img/bao/uploaded/i4/i2/2616970884/O1CN016yhKzP1IOusBQrT0G_!!2-item_pic.png_580x580Q90.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*1999*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search2.alicdn.com/img/bao/uploaded/i4/i2/2616970884/O1CN016yhKzP1IOusBQrT0G_!!2-item_pic.png_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>Apple AirPods Pro 蓝牙耳机</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥1999.00</span>
                    </div>
...
export default BluetoothEarphone8;