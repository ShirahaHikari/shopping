...
import bluetoothEarphone from '..';

let userInfo = window.sessionStorage.getItem('userInfo')
console.log(userInfo)
const { SubMenu } = Menu
const BluetoothEarphone1 = () => {
    let user
    if (userInfo == null) {
        message.error('你没有登录！')
        setTimeout(() => {
    ...
    let userShop = {
        ...
        item: '1MORE/万魔 ComfoBuds Z 睡眠豆 睡觉专用不压耳 防噪音耳塞 侧睡午休无线蓝牙耳机 遮噪降噪隔音',
        priceSum: Math.floor(count*499*1000)/1000,
        count: count,
        price: 499,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i1/109003279/O1CN01N12gzd1a5pSApn5CI_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*499*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i1/109003279/O1CN01N12gzd1a5pSApn5CI_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>1MORE/万魔 ComfoBuds Z 睡眠豆 睡觉专用不压耳 防噪音耳塞 侧睡午休无线蓝牙耳机 遮噪降噪隔音</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥499.00</span>
                    </div>
...
export default BluetoothEarphone1;