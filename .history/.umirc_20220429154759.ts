...
export default defineConfig({
  ...
  routes: [
    ...
    { path: '/food/beer/bear2', component: '@/pages/kindPages/beer/bear2'},//分类 啤酒2
    { path: '/food/beer/bear3', component: '@/pages/kindPages/beer/bear3'},//分类 啤酒3
    { path: '/food/beer/bear4', component: '@/pages/kindPages/beer/bear4'},//分类 啤酒4
    { path: '/food/beer/bear5', component: '@/pages/kindPages/beer/bear5'},//分类 啤酒5
    { path: '/food/beer/bear6', component: '@/pages/kindPages/beer/bear6'},//分类 啤酒6
    { path: '/food/beer/bear7', component: '@/pages/kindPages/beer/bear7'},//分类 啤酒7
    { path: '/food/beer/bear8', component: '@/pages/kindPages/beer/bear8'},//分类 啤酒8
  ],
  fastRefresh: {},
  proxy:{
    '/api':{
