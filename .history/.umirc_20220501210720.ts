...
export default defineConfig({
  ...
  routes: [
    ...
    //以上为零食的小分类
    { path: '/clothes/socks/sock1', component: '@/pages/kindPages/sock/sock1'},//分类 袜子1
    { path: '/clothes/socks/sock2', component: '@/pages/kindPages/sock/sock2'},//分类 袜子2
    { path: '/clothes/socks/sock3', component: '@/pages/kindPages/sock/sock3'},//分类 袜子3
    { path: '/clothes/socks/sock4', component: '@/pages/kindPages/sock/sock4'},//分类 袜子4
    { path: '/clothes/socks/sock5', component: '@/pages/kindPages/sock/sock5'},//分类 袜子5
    { path: '/clothes/socks/sock6', component: '@/pages/kindPages/sock/sock6'},//分类 袜子6
    { path: '/clothes/socks/sock7', component: '@/pages/kindPages/sock/sock7'},//分类 袜子7
    { path: '/clothes/socks/sock8', component: '@/pages/kindPages/sock/sock8'},//分类 袜子8
    //以上为袜子的小分类
    { path: '/bluetoothEarphone', component: '@/pages/searchPages/bluetoothEarphone'}, //搜索 “蓝牙耳机” 界面
    { path: '/sportShoe', component: '@/pages/searchPages/sportShoe'}, //搜索 “运动球鞋” 界面
    //以上为搜索界面大类
    { path: '/bluetoothEarphone/bluetoothEarphone1', component: '@/pages/searchPages/bluetoothEarphone/bluetoothEarphone1'}, //蓝牙耳机1
    { path: '/bluetoothEarphone/bluetoothEarphone2', component: '@/pages/searchPages/bluetoothEarphone/bluetoothEarphone2'}, //蓝牙耳机2
    { path: '/bluetoothEarphone/bluetoothEarphone3', component: '@/pages/searchPages/bluetoothEarphone/bluetoothEarphone3'}, //蓝牙耳机3
    { path: '/bluetoothEarphone/bluetoothEarphone4', component: '@/pages/searchPages/bluetoothEarphone/bluetoothEarphone4'}, //蓝牙耳机4
    { path: '/bluetoothEarphone/bluetoothEarphone5', component: '@/pages/searchPages/bluetoothEarphone/bluetoothEarphone5'}, //蓝牙耳机5
    { path: '/bluetoothEarphone/bluetoothEarphone6', component: '@/pages/searchPages/bluetoothEarphone/bluetoothEarphone6'}, //蓝牙耳机6
    { path: '/bluetoothEarphone/bluetoothEarphone7', component: '@/pages/searchPages/bluetoothEarphone/bluetoothEarphone7'}, //蓝牙耳机7
    { path: '/bluetoothEarphone/bluetoothEarphone8', component: '@/pages/searchPages/bluetoothEarphone/bluetoothEarphone8'}, //蓝牙耳机8
    //以上为蓝牙耳机的小分类
    { path: '/sportShoe/sportShoe1', component: '@/pages/searchPages/sportShoe/sportShoe1'}, //运动球鞋1
    { path: '/sportShoe/sportShoe2', component: '@/pages/searchPages/sportShoe/sportShoe2'}, //运动球鞋2
    { path: '/sportShoe/sportShoe3', component: '@/pages/searchPages/sportShoe/sportShoe3'}, //运动球鞋3
    { path: '/sportShoe/sportShoe4', component: '@/pages/searchPages/sportShoe/sportShoe4'}, //运动球鞋4
    { path: '/sportShoe/sportShoe5', component: '@/pages/searchPages/sportShoe/sportShoe5'}, //运动球鞋5
    { path: '/sportShoe/sportShoe6', component: '@/pages/searchPages/sportShoe/sportShoe6'}, //运动球鞋6
    { path: '/sportShoe/sportShoe7', component: '@/pages/searchPages/sportShoe/sportShoe7'}, //运动球鞋7
    { path: '/sportShoe/sportShoe8', component: '@/pages/searchPages/sportShoe/sportShoe8'}, //运动球鞋8
  ],
  fastRefresh: {},
  proxy:{
    '/api':{
