...
export default defineConfig({
  ...
  routes: [
    ...
    //以上为台式电脑的小分类
    { path: '/computer/deskTop/notebookComputer1', component: '@/pages/kindPages/notebookComputer/notebookComputer1'},//分类 笔记本电脑1
    { path: '/computer/deskTop/notebookComputer2', component: '@/pages/kindPages/notebookComputer/notebookComputer2'},//分类 笔记本电脑2
    { path: '/computer/deskTop/notebookComputer3', component: '@/pages/kindPages/notebookComputer/notebookComputer3'},//分类 笔记本电脑3
    { path: '/computer/deskTop/notebookComputer4', component: '@/pages/kindPages/notebookComputer/notebookComputer4'},//分类 笔记本电脑4
    { path: '/computer/deskTop/notebookComputer5', component: '@/pages/kindPages/notebookComputer/notebookComputer5'},//分类 笔记本电脑5
    { path: '/computer/deskTop/notebookComputer6', component: '@/pages/kindPages/notebookComputer/notebookComputer6'},//分类 笔记本电脑6
    { path: '/computer/deskTop/notebookComputer7', component: '@/pages/kindPages/notebookComputer/notebookComputer7'},//分类 笔记本电脑7
    { path: '/computer/deskTop/notebookComputer8', component: '@/pages/kindPages/notebookComputer/notebookComputer8'},//分类 笔记本电脑8
  ],
  fastRefresh: {},
  proxy:{
    '/api':{
