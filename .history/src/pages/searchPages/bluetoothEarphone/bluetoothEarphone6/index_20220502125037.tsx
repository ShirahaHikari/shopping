...
const BluetoothEarphone6 = () => {
    ...
    let userShop = {
        ...
        item: '漫步者lollipods pro蓝牙耳机主动降噪真无线入耳式男女2021年新款lollipodspro适用于苹果华为小米lollipops',
        priceSum: Math.floor(count*379*1000)/1000,
        count: count,
        price: 379,
        img:'https://g-search2.alicdn.com/img/bao/uploaded/i4/i2/3487767124/O1CN01qCcuvO22UqK1Q9xUv_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type:'蓝牙耳机',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*379*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search2.alicdn.com/img/bao/uploaded/i4/i2/3487767124/O1CN01qCcuvO22UqK1Q9xUv_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>漫步者lollipods pro蓝牙耳机主动降噪真无线入耳式男女2021年新款lollipodspro适用于苹果华为小米lollipops</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥379.00</span>
                    </div>
...
export default BluetoothEarphone6;