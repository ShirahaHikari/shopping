...
const Beer1 = () => {
    ...
    let userShop = {
        ...
        item: 'Forld蓝牙耳机2022年新款真无线运动跑步入耳式超长续航适用于小米vivo华为IQOO通用小型单耳迷你女生可爱款',
        priceSum: Math.floor(count*149*1000)/1000,
        count: count,
        price: 149,
        img:'https://g-search3.alicdn.com/img/bao/uploaded/i4/i2/2137761222/O1CN01YE9u791KtijbWTuBE_!!0-item_pic.jpg_580x580Q90.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i2/2137761222/O1CN01YE9u791KtijbWTuBE_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>Forld蓝牙耳机2022年新款真无线运动跑步入耳式超长续航适用于小米vivo华为IQOO通用小型单耳迷你女生可爱款</h2>
