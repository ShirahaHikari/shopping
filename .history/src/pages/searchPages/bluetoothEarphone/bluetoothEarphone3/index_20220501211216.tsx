...
const BluetoothEarphone3 = () => {
    ...
    let userShop = {
        ...
        item: 'DEVIALET GEMINI帝瓦雷双子星真无线耳机入耳式主动降噪蓝牙耳机',
        priceSum: Math.floor(count*1980*1000)/1000,
        count: count,
        price: 1980,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i2/387980033/O1CN01Ti2yhA1C79oVYQmSm_!!2-saturn_solar.png_580x580Q90.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*1980*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i2/387980033/O1CN01Ti2yhA1C79oVYQmSm_!!2-saturn_solar.png_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>DEVIALET GEMINI帝瓦雷双子星真无线耳机入耳式主动降噪蓝牙耳机</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>1980.00</span>
                    </div>
...
export default BluetoothEarphone3;