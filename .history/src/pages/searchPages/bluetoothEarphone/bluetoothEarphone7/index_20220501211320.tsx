...
const BluetoothEarphone7 = () => {
    ...
    let userShop = {
        ...
        item: '漫步者TO-U3蓝牙耳机真无线半入耳式运动游戏降噪新款男女生士高品质2021年冇心X2适用于苹果华为小米n2pods',
        priceSum: Math.floor(count*268*1000)/1000,
        count: count,
        price: 268,
        img:'https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/3487767124/O1CN01VDifhM22UqKFO9NvL_!!0-item_pic.jpg_580x580Q90.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*268*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/3487767124/O1CN01VDifhM22UqKFO9NvL_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>漫步者TO-U3蓝牙耳机真无线半入耳式运动游戏降噪新款男女生士高品质2021年冇心X2适用于苹果华为小米n2pods</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥268.00</span>
                    </div>
...
export default BluetoothEarphone7;