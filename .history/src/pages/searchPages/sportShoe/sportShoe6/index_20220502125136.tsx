...
const SportShoe6 = () => {
    ...
    let userShop = {
        ...
        item: '安踏异形3丨氮科技篮球鞋男2022夏季新款中帮专业实战球鞋运动鞋',
        priceSum: Math.floor(count*429*1000)/1000,
        count: count,
        price: 429,
        img:'https://g-search2.alicdn.com/img/bao/uploaded/i4/i3/385132127/O1CN01APKyS31RaDBVCdcLp_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type:'运动球鞋',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*429*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search2.alicdn.com/img/bao/uploaded/i4/i3/385132127/O1CN01APKyS31RaDBVCdcLp_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>安踏异形3丨氮科技篮球鞋男2022夏季新款中帮专业实战球鞋运动鞋</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥429.00</span>
                    </div>
