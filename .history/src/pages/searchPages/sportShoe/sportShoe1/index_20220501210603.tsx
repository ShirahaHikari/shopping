...
const SportShoe1 = () => {
    ...
    let userShop = {
        ...
        item: 'FILA斐乐官方男子跑步鞋MARS II火星二代新款复古运动鞋减震男鞋',
        priceSum: Math.floor(count*639*1000)/1000,
        count: count,
        price: 639,
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*639*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                ...
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>FILA斐乐官方男子跑步鞋MARS II火星二代新款复古运动鞋减震男鞋</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥639.00</span>
                    </div>
