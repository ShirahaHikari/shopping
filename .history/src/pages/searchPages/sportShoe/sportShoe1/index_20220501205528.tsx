...
const Beer1 = () => {
    ...
    let userShop = {
        ...
        count: count,
        price: 499,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i3/26340702/O1CN01drM2Yv1H3YjqPYwv2_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i3/26340702/O1CN01drM2Yv1H3YjqPYwv2_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
