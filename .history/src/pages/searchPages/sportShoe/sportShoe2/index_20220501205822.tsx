...
const Beer1 = () => {
    ...
    let userShop = {
        ...
        count: count,
        price: 499,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i4/283680162/O1CN017eTCib1D4ErlvpycR_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i4/283680162/O1CN017eTCib1D4ErlvpycR_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
