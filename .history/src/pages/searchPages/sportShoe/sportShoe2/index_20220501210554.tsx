...
const SportShoe2 = () => {
    ...
    let userShop = {
        ...
        item: 'STARTER男女同款新款潮流运动VOL复古休闲百搭白色中帮板鞋',
        priceSum: Math.floor(count*819*1000)/1000,
        count: count,
        price: 819,
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*819*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                ...
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>STARTER男女同款新款潮流运动VOL复古休闲百搭白色中帮板鞋</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥819.00</span>
                    </div>
