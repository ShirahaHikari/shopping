...
const SportShoe5 = () => {
    ...
    let userShop = {
        ...
        item: '李宁beng篮球鞋男鞋利刃2实战球鞋专业官方正品夏季透气运动鞋男',
        priceSum: Math.floor(count*598*1000)/1000,
        count: count,
        price: 598,
        img:'https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/92688455/O1CN014GBAsE2CKRULHEAss_!!92688455.jpg_580x580Q90.jpg_.webp',
        type:'运动球鞋',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*598*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/92688455/O1CN014GBAsE2CKRULHEAss_!!92688455.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>李宁beng篮球鞋男鞋利刃2实战球鞋专业官方正品夏季透气运动鞋男</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥598.00</span>
                    </div>
