...
const SportShoe4 = () => {
    ...
    let userShop = {
        ...
        item: '李宁beng篮球鞋男驭帅14LOW奥兰多暮色实战球鞋2022夏季运动鞋',
        priceSum: Math.floor(count*1199*1000)/1000,
        count: count,
        price: 1199,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/i4/92688455/O1CN01duAD0t2CKRUTfAJyQ_!!92688455.jpg_580x580Q90.jpg_.webp',
        type:'运动球鞋',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*1199*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/i4/92688455/O1CN01duAD0t2CKRUTfAJyQ_!!92688455.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>李宁beng篮球鞋男驭帅14LOW奥兰多暮色实战球鞋2022夏季运动鞋</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥1199.00</span>
                    </div>
