...
const LoginPage = () => {
    ...
    let imgString = 'https://img1.baidu.com/it/u=3339245679,4162353878&fm=253&fmt=auto&app=138&f=JPEG?w=1180&h=369'
    return (
        <div style = {{
            backgroundColor:'red',
            backgroundImage:`url('https://img1.baidu.com/it/u=3339245679,4162353878&fm=253&fmt=auto&app=138&f=JPEG?w=1180&h=369')`
        }}>
            <div style={{
                backgroundColor:'red'
                left: '100px',
