            ...
            <div className={styles.itemDetail}>
                ...
                <div className={styles.wordRight}>
                    ...
                    <div style={{backgroundColor:'rgb(255,242,232'}}>
                        <span>价格   </span>
                        <span style={{color:'orange',fontSize:'30px',marginLeft:23,fontWeight:'bold'}}>￥9.90</span>
                    </div>
                    ...
                    <button style={{backgroundColor:'rgb(255,228,208'}}>立即购买</button>
                    <button style={{backgroundColor:'orange'}}>加入购物车</button>
                </div>
            </div>
        </div>
    )
