        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%' ,height:'3000px'}}>
            ...
            <div className={styles.itemDetail}>
                ...
                <div className={styles.wordRight}>
                    ...
                    <button style={{backgroundColor:'rgb(255,228,208',color:'rgb(229,81,29)',marginTop:20}}>立即购买</button>
                    <button style={{backgroundColor:'orange',color:'white',marginLeft:20,width:300,height:200}}>加入购物车</button>
                </div>
            </div>
        </div>
    )
