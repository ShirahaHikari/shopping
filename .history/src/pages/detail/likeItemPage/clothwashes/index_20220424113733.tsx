...
const japaneseHat = () => {
    ...
    let userShop = {
        ...
        item: '超能袋装洗衣液2袋补充替换装家庭装低泡天然皂液',
        priceSum: Math.floor(count*6.8*1000)/1000,
        count: count,
        price: 6.8,
        img:'https://img.alicdn.com/bao/uploaded/i3/2208876287325/O1CN01AtlLxF23ytvWVINHY_!!2208876287325.jpg_468x468q75.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*6.8*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                ...
                <div className={styles.picLeft}>
                    <img src='https://img.alicdn.com/bao/uploaded/i3/2208876287325/O1CN01AtlLxF23ytvWVINHY_!!2208876287325.jpg_468x468q75.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>超能袋装洗衣液2袋补充替换装家庭装低泡天然皂液</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥6.80</span>
                    </div>
