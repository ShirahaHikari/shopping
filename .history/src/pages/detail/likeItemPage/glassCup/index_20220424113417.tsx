...
const japaneseHat = () => {
    ...
    let userShop = {
        ...
        item: '刻度吸管玻璃杯ins家用奶茶网红牛奶果汁水杯子带盖',
        priceSum: Math.floor(count*9.9*1000)/1000,
        count: count,
        price:9.9,
        img:'https://img.alicdn.com/bao/uploaded/i1/2206752199928/O1CN01nE6kkv2ND4lad41vz_!!2206752199928-0-lubanu-s.jpg_468x468q75.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                ...
                <div className={styles.picLeft}>
                    <img src='https://img.alicdn.com/bao/uploaded/i1/2206752199928/O1CN01nE6kkv2ND4lad41vz_!!2206752199928-0-lubanu-s.jpg_468x468q75.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>刻度吸管玻璃杯ins家用奶茶网红牛奶果汁水杯子带盖</h2>
