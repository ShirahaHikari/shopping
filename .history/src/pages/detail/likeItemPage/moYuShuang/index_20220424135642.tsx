...
const japaneseHat = () => {
    ...
    let userShop = {
        ...
        item: '卫龙魔芋爽散装称重2斤约60包香辣麻辣酸辣魔芋丝素毛肚休闲零食',
        priceSum: Math.floor(count*12.9*1000)/1000,
        count: count,
        price: 12.9,
        img:'https://img.alicdn.com/bao/uploaded/i3/2212458146507/O1CN01C2hgQ51xwFuslNrA6_!!2212458146507.jpg_468x468q75.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*12.9*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                ...
                <div className={styles.picLeft}>
                    <img src='https://img.alicdn.com/bao/uploaded/i3/2212458146507/O1CN01C2hgQ51xwFuslNrA6_!!2212458146507.jpg_468x468q75.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>卫龙魔芋爽散装称重2斤约60包香辣麻辣酸辣魔芋丝素毛肚休闲零食</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥12.90</span>
                    </div>
