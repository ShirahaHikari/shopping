...
const japaneseHat = () => {
    ...
    let userShop = {
        ...
        item: '新款复古格子毛呢连衣裙女秋冬时尚减龄中长款背带裙学院风鱼尾裙',
        priceSum: Math.floor(count*9.9*1000)/1000,
        count: count,
        price:9.9,
        img:'https://img.alicdn.com/bao/uploaded/i3/845371903/O1CN01v2JhI11PvcLDJbdmC_!!0-item_pic.jpg_468x468q75.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                ...
                <div className={styles.picLeft}>
                    <img src='https://img.alicdn.com/bao/uploaded/i3/845371903/O1CN01v2JhI11PvcLDJbdmC_!!0-item_pic.jpg_468x468q75.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>新款复古格子毛呢连衣裙女秋冬时尚减龄中长款背带裙学院风鱼尾裙</h2>
