            ...
            <div className={styles.itemDetail}>
                ...
                <div className={styles.wordRight}>
                    ...
                    <div style={{ width: 400, marginTop: 20 }}>数量
                        <button onClick={sub} style={{ marginLeft: 20, marginRight: 20,backgroundColor:'white',border:"0.5px solid grey",borderRadius:'10px' }}>-</button>
                        <input className={styles.count} value={count} onChange={(e)=>{setCount(Number(e.target.value))}}/>
                        <button onClick={add} style={{ marginLeft: 20,backgroundColor:'white',border:"0.5px solid grey" }}>+</button>
                    </div>
