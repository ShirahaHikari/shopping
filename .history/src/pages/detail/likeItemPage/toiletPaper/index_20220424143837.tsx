        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                ...
                <div className={styles.wordRight}>
                    ...
                    <button style={{ backgroundColor: 'rgb(255,228,208)', color: 'rgb(229,81,29)', marginTop: 20, width: 130, height: 40 ,border: "1px solid black",borderRadius:6}} onClick={buy}>立即购买</button>
