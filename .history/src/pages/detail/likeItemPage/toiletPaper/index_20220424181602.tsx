...
const japaneseHat = () => {
    ...
    let userShop = {
        ...
        item: '心相印纸巾抽纸整箱大包家用实惠装卫生纸心心相印餐巾纸',
        priceSum: Math.floor(count*9.9*1000)/1000,
        count: count,
        price:9.9,
        img: 'https://img.alicdn.com/bao/uploaded/i1/1729128393/O1CN01X54gIz2Bs2rNqc5tf_!!0-item_pic.jpg_468x468q75.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*9.9*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                ...
                <div className={styles.picLeft}>
                    <img src={'https://img.alicdn.com/bao/uploaded/i1/1729128393/O1CN01X54gIz2Bs2rNqc5tf_!!0-item_pic.jpg_468x468q75.jpg_.webp'} style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>心相印纸巾抽纸整箱大包家用实惠装卫生纸心心相印餐巾纸</h2>
