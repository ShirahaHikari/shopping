...
const japaneseHat = () => {
    ...
    let userShop = {
        ...
        item: '冻干草莓水果干果脯草莓干草莓脆解馋网红零食小吃休闲食品',
        priceSum: Math.floor(count*9.9*1000)/1000,
        count: count,
        price:9.9,
        img:'https://img.alicdn.com/bao/uploaded/i1/3160935493/O1CN01ECDbQE1qRqKrn2obV_!!0-item_pic.jpg_468x468q75.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                ...
                <div className={styles.picLeft}>
                    <img src='https://img.alicdn.com/bao/uploaded/i1/3160935493/O1CN01ECDbQE1qRqKrn2obV_!!0-item_pic.jpg_468x468q75.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>冻干草莓水果干果脯草莓干草莓脆解馋网红零食小吃休闲食品</h2>
