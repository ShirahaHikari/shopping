...
const japaneseHat = () => {
    ...
    let userShop = {
        ...
        item: '懒人自热小火锅速食牛肉重庆便宜土豆粉自助网红麻辣烫',
        priceSum: Math.floor(count*9.9*1000)/1000,
        count: count,
        price: 9.9,
        img: 'https://img.alicdn.com/bao/uploaded/i2/3704112085/O1CN01od3XuL1RGyUJN2kxC_!!3704112085.jpg_468x468q75.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                ...
                <div className={styles.picLeft}>
                    <img src='https://img.alicdn.com/bao/uploaded/i2/3704112085/O1CN01od3XuL1RGyUJN2kxC_!!3704112085.jpg_468x468q75.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>懒人自热小火锅速食牛肉重庆便宜土豆粉自助网红麻辣烫</h2>
