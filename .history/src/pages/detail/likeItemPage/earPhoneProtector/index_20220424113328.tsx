...
const japaneseHat = () => {
    ...
    let userShop = {
        ...
        item: 'VIVOTWS 2真无线降噪耳机保护套vivotws2蓝牙保护壳',
        priceSum: Math.floor(count*8.8*1000)/1000,
        count: count,
        price:8.8,
        img:'https://img.alicdn.com/bao/uploaded/i2/2208076844301/O1CN01RFNFCB1hduA3hfvLK_!!0-item_pic.jpg_468x468q75.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*8.8*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                ...
                <div className={styles.picLeft}>
                    <img src='https://img.alicdn.com/bao/uploaded/i2/2208076844301/O1CN01RFNFCB1hduA3hfvLK_!!0-item_pic.jpg_468x468q75.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>VIVOTWS 2真无线降噪耳机保护套vivotws2蓝牙保护壳</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥8.80</span>
                    </div>
