...
const japaneseHat = () => {
    ...
    let userShop = {
        ...
        item: 'ZEBRA斑马官方旗舰店稀有限定红羽毛笔三丽鸥库洛米美乐蒂中性笔',
        priceSum: Math.floor(count*31.04*1000)/1000,
        count: count,
        price: 31.04,
        img:'https://img.alicdn.com/bao/uploaded/i4/2265082706/O1CN01T7Jyd01VrOSYf2UWK_!!2265082706.jpg_468x468q75.jpg_.webp'
    }
    function add() {
        setCount(count + 1)
    }
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*31.04*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                ...
                <div className={styles.picLeft}>
                    <img src='https://img.alicdn.com/bao/uploaded/i4/2265082706/O1CN01T7Jyd01VrOSYf2UWK_!!2265082706.jpg_468x468q75.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>ZEBRA斑马官方旗舰店稀有限定红羽毛笔三丽鸥库洛米美乐蒂中性笔</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥31.04</span>
                    </div>
