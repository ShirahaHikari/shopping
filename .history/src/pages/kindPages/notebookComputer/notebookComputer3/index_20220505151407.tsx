...
const NotebookComputer3 = () => {
    ...
    let userShop = {
        ...
        item: 'MFQBW 全新游戏本英特尔酷睿i7轻便超薄手提电脑轻薄便携学生女生商务办公学习游戏学生大学生笔记本电脑吃鸡',
        priceSum: Math.floor(count * 1398 * 1000) / 1000,
        count: count,
        price: 1398,
        img: 'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i2/1299040067/O1CN01XvLOcm1CMjG5nvLlV_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type: '笔记本电脑',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 1398 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i2/1299040067/O1CN01XvLOcm1CMjG5nvLlV_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>MFQBW 全新游戏本英特尔酷睿i7轻便超薄手提电脑轻薄便携学生女生商务办公学习游戏学生大学生笔记本电脑吃鸡</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥1398.00</span>
                    </div>
...
export default NotebookComputer3;