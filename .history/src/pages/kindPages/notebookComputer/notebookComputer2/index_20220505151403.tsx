...
const NotebookComputer2 = () => {
    ...
    let userShop = {
        ...
        item: '【11代新品】全新款笔记本电脑办公用商务15.6英寸轻薄便携手提电脑游戏本高配高性能大学生女生款超薄超极本',
        priceSum: Math.floor(count*1548*1000)/1000,
        count: count,
        price: 1548,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i2/489660139/O1CN01bkILGv1Ctho0erBU2_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type:'笔记本电脑',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*1548*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i2/489660139/O1CN01bkILGv1Ctho0erBU2_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>【11代新品】全新款笔记本电脑办公用商务15.6英寸轻薄便携手提电脑游戏本高配高性能大学生女生款超薄超极本</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥1548.00</span>
                    </div>
...
export default NotebookComputer2;