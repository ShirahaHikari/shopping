...
const NotebookComputer4 = () => {
    ...
    let userShop = {
        ...
        item: '华为笔记本电脑/HUAWEI MateBook 13 11代酷睿处理器16GB+512GB锐炬显卡2K护眼屏轻薄办公全面屏wifi 6',
        priceSum: Math.floor(count * 5199 * 1000) / 1000,
        count: count,
        price: 5199,
        img: 'https://g-search2.alicdn.com/img/bao/uploaded/i4/i3/2838892713/O1CN014epHub1VubHPpKRUj_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type: '笔记本电脑',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 5199 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search2.alicdn.com/img/bao/uploaded/i4/i3/2838892713/O1CN014epHub1VubHPpKRUj_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>华为笔记本电脑/HUAWEI MateBook 13 11代酷睿处理器16GB+512GB锐炬显卡2K护眼屏轻薄办公全面屏wifi 6</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥5199.00</span>
                    </div>
...
export default NotebookComputer4;