...
const NotebookComputer6 = () => {
    ...
    let userShop = {
        ...
        item: '【稀缺现货】DELL/戴尔 2022新款G15 5520 12代英特尔酷睿i5游匣游戏本3070笔记本电脑3060手提15.6英寸学生',
        priceSum: Math.floor(count * 6899 * 1000) / 1000,
        count: count,
        price: 6899,
        img: 'https://g-search3.alicdn.com/img/bao/uploaded/i4/i4/379092568/O1CN01pBCb9I1UqBqgydyzn_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type: '笔记本电脑',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 6899 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i4/379092568/O1CN01pBCb9I1UqBqgydyzn_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>【稀缺现货】DELL/戴尔 2022新款G15 5520 12代英特尔酷睿i5游匣游戏本3070笔记本电脑3060手提15.6英寸学生</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥6899.00</span>
                    </div>
...
export default NotebookComputer6;