...
const NotebookComputer7 = () => {
    ...
    let userShop = {
        ...
        item: '【24期免息】ROG幻14AMD锐龙R9/RTX3060轻薄本2.5K屏手提设计师大学生游戏笔记本电脑办公玩家国度官方旗舰店',
        priceSum: Math.floor(count * 9999 * 1000) / 1000,
        count: count,
        price: 9999,
        img: 'https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/2745641605/O1CN01nYzuR71Nj8RKNhoSz_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type: '笔记本电脑',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 9999 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/2745641605/O1CN01nYzuR71Nj8RKNhoSz_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>【24期免息】ROG幻14AMD锐龙R9/RTX3060轻薄本2.5K屏手提设计师大学生游戏笔记本电脑办公玩家国度官方旗舰店</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥9999.00</span>
                    </div>
...
export default NotebookComputer7;