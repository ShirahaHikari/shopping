...
const NotebookComputer8 = () => {
    ...
    let userShop = {
        ...
        item: '【天猫V榜推荐】DELL/戴尔 G15 15.6英寸游匣游戏本英特尔酷睿i5灵越笔记本电脑5511学生i7电竞5510手提轻薄',
        priceSum: Math.floor(count * 6399 * 1000) / 1000,
        count: count,
        price: 6399,
        img: 'https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/379092568/O1CN01lcKnPG1UqBqh4skUV_!!2-item_pic.png_580x580Q90.jpg_.webp',
        type: '笔记本电脑',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 6399 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/379092568/O1CN01lcKnPG1UqBqh4skUV_!!2-item_pic.png_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>【天猫V榜推荐】DELL/戴尔 G15 15.6英寸游匣游戏本英特尔酷睿i5灵越笔记本电脑5511学生i7电竞5510手提轻薄</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥6399.00</span>
                    </div>
...
export default NotebookComputer8;