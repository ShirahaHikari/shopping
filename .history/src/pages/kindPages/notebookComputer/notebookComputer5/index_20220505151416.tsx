...
const NotebookComputer5 = () => {
    ...
    let userShop = {
        ...
        item: '【热销爆品】Xiaomi/RedmiBook Pro 14 11代英特尔酷睿i5/i7笔记本电脑轻薄便携学生办公商务小米官方旗舰店',
        priceSum: Math.floor(count * 4799 * 1000) / 1000,
        count: count,
        price: 4799,
        img: 'https://g-search1.alicdn.com/img/bao/uploaded/i4/i2/1714128138/O1CN01yer7vZ29zFw2wS3dU_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type: '笔记本电脑',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 4799 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/i2/1714128138/O1CN01yer7vZ29zFw2wS3dU_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>【热销爆品】Xiaomi/RedmiBook Pro 14 11代英特尔酷睿i5/i7笔记本电脑轻薄便携学生办公商务小米官方旗舰店</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥4799.00</span>
                    </div>
...
export default NotebookComputer5;