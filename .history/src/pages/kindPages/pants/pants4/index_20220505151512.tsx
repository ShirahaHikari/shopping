...
const Pants4 = () => {
    ...
    let userShop = {
        ...
        item: '安踏速干裤丨运动裤男士2022夏季冰丝梭织薄款透气速干直筒长裤子',
        priceSum: Math.floor(count * 169 * 1000) / 1000,
        count: count,
        price: 169,
        img: 'https://g-search3.alicdn.com/img/bao/uploaded/i4/i2/385132127/O1CN01IPwELl1RaDBWcVaxd-385132127.jpg_580x580Q90.jpg_.webp',
        type: '裤子',
    }
    function add() {
        setCount(count + 1)
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i2/385132127/O1CN01IPwELl1RaDBWcVaxd-385132127.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>安踏速干裤丨运动裤男士2022夏季冰丝梭织薄款透气速干直筒长裤子</h2>
