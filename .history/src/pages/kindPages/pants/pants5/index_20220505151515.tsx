...
const Pants5 = () => {
    ...
    let userShop = {
        ...
        item: 'GXG男装 【凉凉衣】冰感华夫格白裤子男休闲长裤卫裤22年夏季新品',
        priceSum: Math.floor(count * 219 * 1000) / 1000,
        count: count,
        price: 219,
        img: 'https://g-search1.alicdn.com/img/bao/uploaded/i4/i1/454291526/O1CN01dNhPsk1N8x9GEIZpN_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type: '裤子',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 219 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/i1/454291526/O1CN01dNhPsk1N8x9GEIZpN_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>GXG男装 【凉凉衣】冰感华夫格白裤子男休闲长裤卫裤22年夏季新品</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥219.00</span>
                    </div>
