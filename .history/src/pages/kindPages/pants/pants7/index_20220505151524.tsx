...
const Pants7 = () => {
    ...
    let userShop = {
        ...
        item: '李宁卫裤男士长裤新款束脚针织裤子春夏黑色男裤健身运动裤休闲裤',
        priceSum: Math.floor(count * 118 * 1000) / 1000,
        count: count,
        price: 118,
        img: 'https://g-search2.alicdn.com/img/bao/uploaded/i4/i2/92688455/O1CN01iMFJqc2CKRUJgdn1A_!!92688455.jpg_580x580Q90.jpg_.webp',
        type: '裤子',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 118 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search2.alicdn.com/img/bao/uploaded/i4/i2/92688455/O1CN01iMFJqc2CKRUJgdn1A_!!92688455.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>李宁卫裤男士长裤新款束脚针织裤子春夏黑色男裤健身运动裤休闲裤</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥118.00</span>
                    </div>
