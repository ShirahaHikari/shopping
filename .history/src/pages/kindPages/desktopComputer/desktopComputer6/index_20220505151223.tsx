...
const DesktopComputer6 = () => {
    ...
    let userShop = {
        ...
        item: '攀升 酷睿i7 12代主机12700F/RTX3060/3060Ti电脑主机高配电竞吃鸡水冷游戏主机DIY台式电脑组装机全套',
        priceSum: Math.floor(count * 7999 * 1000) / 1000,
        count: count,
        price: 7999,
        img: 'https://picasso.alicdn.com/imgextra/O1CNA1PyBCIW2DnaJ97God2_!!1652528654-0-psf.jpg_580x580Q90.jpg_.webp',
        type: '台式电脑',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 7999 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://picasso.alicdn.com/imgextra/O1CNA1PyBCIW2DnaJ97God2_!!1652528654-0-psf.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>攀升 酷睿i7 12代主机12700F/RTX3060/3060Ti电脑主机高配电竞吃鸡水冷游戏主机DIY台式电脑组装机全套</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥7999.00</span>
                    </div>
...
export default DesktopComputer6;