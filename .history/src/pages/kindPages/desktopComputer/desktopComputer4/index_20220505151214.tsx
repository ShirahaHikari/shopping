...
const DesktopComputer4 = () => {
    ...
    let userShop = {
        ...
        item: '【网课一体机】联想一体机AIO520 21.5/23.8/27英寸一体机台式电脑一体机家用学习办公台式机网课一体机电脑',
        priceSum: Math.floor(count*4699*1000)/1000,
        count: count,
        price: 4699,
        img:'https://g-search3.alicdn.com/img/bao/uploaded/i4/i3/126446588/O1CN015qCZl11yXM29QDPR6_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type:'台式电脑',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*4699*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i3/126446588/O1CN015qCZl11yXM29QDPR6_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>【网课一体机】联想一体机AIO520 21.5/23.8/27英寸一体机台式电脑一体机家用学习办公台式机网课一体机电脑</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥4699.00</span>
                    </div>
...
export default DesktopComputer4;