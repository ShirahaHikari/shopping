...
const DesktopComputer5 = () => {
    ...
    let userShop = {
        ...
        item: '【24期免息】ALIENWARE外星人全新Aurora R12台式机11代酷睿i7游戏电竞电脑主机3070整机高端官方旗舰店台机',
        priceSum: Math.floor(count*15999*1000)/1000,
        count: count,
        price: 15999,
        img:'https://g-search3.alicdn.com/img/bao/uploaded/i4/i2/2510050218/O1CN01zrkagK1DTt60HvrD0_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type:'台式电脑',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*15999*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i2/2510050218/O1CN01zrkagK1DTt60HvrD0_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>【24期免息】ALIENWARE外星人全新Aurora R12台式机11代酷睿i7游戏电竞电脑主机3070整机高端官方旗舰店台机</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥15999.00</span>
                    </div>
...
export default DesktopComputer5;