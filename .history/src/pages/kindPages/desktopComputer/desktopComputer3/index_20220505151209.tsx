...
const DesktopComputer3 = () => {
    ...
    let userShop = {
        ...
        count: count,
        price: 998,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i1/114749949/O1CN01O5j7sn2NMhCMCrwEF_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type:'台式电脑',
    }
    function add() {
        setCount(count + 1)
...
export default DesktopComputer3;