            ...
            <div className={styles.mainPage} id='top'>
                ...
                <div className={styles.guessYouLikeItems}>
                    ...
                    <div style={{ position: 'relative', width: '300px', height: '350px' }}>
                        ...
                        <a href="likeItems/japaneseHat"><span style={{ position: 'absolute', bottom: '50px', width: '250px', right: '0px' }}>【24期免息】ROG幻14AMD锐龙R9/RTX3060轻薄本2.5K屏手提设计师大学生游戏笔记本电脑办公玩家国度官方旗舰店</span></a>
                        <p style={{ position: 'absolute', bottom: '0px', color: 'red', fontSize: '20px', left: '44px' }}>￥9.90</p>
                    </div>
                    <div style={{ position: 'relative', width: '300px', height: '350px' }}>
                    ...
                    <div style={{ position: 'relative', width: '300px', height: '350px' }} id='bottom'>
