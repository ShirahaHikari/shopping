...
const DesktopComputer8 = () => {
    ...
    let userShop = {
        ...
        item: '【4年金牌服务】Dell/戴尔Vostro成就3681/3910/5890INTEL酷睿i3/i5/i7迷你mini/标准机箱可选台式机电脑主机',
        priceSum: Math.floor(count * 2339 * 1000) / 1000,
        count: count,
        price: 2339,
        img: 'https://g-search2.alicdn.com/img/bao/uploaded/i4/i2/379092568/O1CN01iur3nS1UqBqdjOP2p_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type: '台式电脑',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 2339 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search2.alicdn.com/img/bao/uploaded/i4/i2/379092568/O1CN01iur3nS1UqBqdjOP2p_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>【4年金牌服务】Dell/戴尔Vostro成就3681/3910/5890INTEL酷睿i3/i5/i7迷你mini/标准机箱可选台式机电脑主机</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥2339.00</span>
                    </div>
...
export default DesktopComputer8;