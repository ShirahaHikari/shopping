...
const DesktopComputer1 = () => {
    ...
    let userShop = {
        ...
        item: '酷睿i5四核i7六核/16G/GTX1060独显台式机组装台式电脑主机电竞整机全套家用企业办公全新官方正品吃鸡游戏',
        priceSum: Math.floor(count * 1399 * 1000) / 1000,
        count: count,
        price: 1399,
        img: 'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i1/114749949/O1CN01aoVcOq2NMhCu9kQry_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type: '台式电脑',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 1399 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i1/114749949/O1CN01aoVcOq2NMhCu9kQry_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>酷睿i5四核i7六核/16G/GTX1060独显台式机组装台式电脑主机电竞整机全套家用企业办公全新官方正品吃鸡游戏</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥1399.00</span>
                    </div>
