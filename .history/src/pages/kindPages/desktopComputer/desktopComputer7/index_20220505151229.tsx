...
const DesktopComputer7 = () => {
    ...
    let userShop = {
        ...
        item: '【12代酷睿游戏主机】联想刃7000K 2022 RTX3060/3060Ti/3070 游戏电竞台机 设计师台式主机联想台式机电脑',
        priceSum: Math.floor(count * 8198 * 1000) / 1000,
        count: count,
        price: 8198,
        img: 'https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/126446588/O1CN01v5ZDAd1yXM25rPgrZ_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type: '台式电脑',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 8198 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/126446588/O1CN01v5ZDAd1yXM25rPgrZ_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>【12代酷睿游戏主机】联想刃7000K 2022 RTX3060/3060Ti/3070 游戏电竞台机 设计师台式主机联想台式机电脑</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥8198.00</span>
                    </div>
...
export default DesktopComputer7;