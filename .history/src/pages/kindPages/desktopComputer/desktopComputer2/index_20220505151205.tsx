...
const DesktopComputer2 = () => {
    ...
    let userShop = {
        ...
        item: '然硕 酷睿i5 10400F/12400F/华硕RTX3050独显台式电脑主机高配吃鸡电竞游戏DIY组装机直播设计师办公整机全套',
        priceSum: Math.floor(count * 2399 * 1000) / 1000,
        count: count,
        price: 2399,
        img: 'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i3/28808769/O1CN01b2VxpV2EeFqcEfQB1_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type: '台式电脑',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 2399 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i3/28808769/O1CN01b2VxpV2EeFqcEfQB1_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>然硕 酷睿i5 10400F/12400F/华硕RTX3050独显台式电脑主机高配吃鸡电竞游戏DIY组装机直播设计师办公整机全套</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥2399.00</span>
                    </div>
