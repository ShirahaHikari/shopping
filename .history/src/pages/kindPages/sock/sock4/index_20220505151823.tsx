...
const Sock4 = () => {
    ...
    let userShop = {
        ...
        item: '【王一博同款】蕉内子弹袜501S短袜女中筒袜男士袜子夏季棉袜4双',
        priceSum: Math.floor(count*69.9*1000)/1000,
        count: count,
        price: 69.9,
        img:'https://g-search2.alicdn.com/img/bao/uploaded/i4/i4/3035493001/O1CN019X6x8e1Y2VLVTlzdW_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type:'袜子',
    }
    function add() {
        setCount(count + 1)
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search2.alicdn.com/img/bao/uploaded/i4/i4/3035493001/O1CN019X6x8e1Y2VLVTlzdW_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>【王一博同款】蕉内子弹袜501S短袜女中筒袜男士袜子夏季棉袜4双</h2>
