...
const Beer1 = () => {
    ...
    let userShop = {
        ...
        item: '迪卡侬运动袜男女短袜专业篮球夏长袜健身训练马拉松跑步袜子MSTS',
        priceSum: Math.floor(count*39.8*1000)/1000,
        count: count,
        price: 39.8,
        img:'https://g-search2.alicdn.com/img/bao/uploaded/i4/i4/352469034/O1CN01ezpqTQ2GbcoMmpgns-352469034.jpg_580x580Q90.jpg_.webp',
        type:'袜子',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*39.8*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search2.alicdn.com/img/bao/uploaded/i4/i4/352469034/O1CN01ezpqTQ2GbcoMmpgns-352469034.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>迪卡侬运动袜男女短袜专业篮球夏长袜健身训练马拉松跑步袜子MSTS</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥39.80</span>
                    </div>
