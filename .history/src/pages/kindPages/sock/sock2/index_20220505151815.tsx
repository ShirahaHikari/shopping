...
const Sock2 = () => {
    ...
    let userShop = {
        ...
        item: 'aicare防臭袜子男士中筒棉袜春夏季吸汗抗菌除臭四季长袜商务男袜',
        priceSum: Math.floor(count*99*1000)/1000,
        count: count,
        price: 99,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i4/29243035/O1CN0149Fo5W1YI4mqURLMO_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type:'袜子',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*99*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i4/29243035/O1CN0149Fo5W1YI4mqURLMO_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>aicare防臭袜子男士中筒棉袜春夏季吸汗抗菌除臭四季长袜商务男袜</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥99.00</span>
                    </div>
