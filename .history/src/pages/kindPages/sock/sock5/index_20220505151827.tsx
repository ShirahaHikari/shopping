...
const Sock5 = () => {
    ...
    let userShop = {
        ...
        item: '船袜男夏款纯棉薄款抗菌防臭吸汗黑色夏季浅口隐形袜子男士短袜',
        priceSum: Math.floor(count*39.8*1000)/1000,
        count: count,
        price: 39.8,
        img:'https://picasso.alicdn.com/imgextra/O1CNA1GgXZxe1NqSm9WJuLR_!!1025001621-0-psf.jpg_580x580Q90.jpg_.webp',
        type:'袜子',
    }
    function add() {
        setCount(count + 1)
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://picasso.alicdn.com/imgextra/O1CNA1GgXZxe1NqSm9WJuLR_!!1025001621-0-psf.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>船袜男夏款纯棉薄款抗菌防臭吸汗黑色夏季浅口隐形袜子男士短袜</h2>
