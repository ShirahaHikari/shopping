...
const Sock7 = () => {
    ...
    let userShop = {
        ...
        item: '有棵树男袜子船袜短款隐形男士短袜潮夏季薄款透气防臭吸汗棉春秋',
        priceSum: Math.floor(count*59.9*1000)/1000,
        count: count,
        price: 59.9,
        img:'https://picasso.alicdn.com/imgextra/O1CNA1VWd5s01PGrDS3PGVR_!!4128631814-0-psf.jpg_580x580Q90.jpg_.webp',
        type:'袜子',
    }
    function add() {
        setCount(count + 1)
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://picasso.alicdn.com/imgextra/O1CNA1VWd5s01PGrDS3PGVR_!!4128631814-0-psf.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>有棵树男袜子船袜短款隐形男士短袜潮夏季薄款透气防臭吸汗棉春秋</h2>
