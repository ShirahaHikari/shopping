...
const Sock6 = () => {
    ...
    let userShop = {
        ...
        item: '蕉内妥妥袜防掉跟浅口隐形袜500E抑菌袜子男短袜棉防滑船袜女夏季',
        priceSum: Math.floor(count*69.9*1000)/1000,
        count: count,
        price: 69.9,
        img:'https://g-search3.alicdn.com/img/bao/uploaded/i4/i3/3035493001/O1CN01teV6xV1Y2VLPyh6x4_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type:'袜子',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*69.9*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i3/3035493001/O1CN01teV6xV1Y2VLPyh6x4_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>蕉内妥妥袜防掉跟浅口隐形袜500E抑菌袜子男短袜棉防滑船袜女夏季</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥69.90</span>
                    </div>
