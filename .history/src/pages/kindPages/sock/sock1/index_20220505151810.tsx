...
const Sock1 = () => {
    ...
    let userShop = {
        ...
        item: '花花公子袜子男士短袜纯棉抗菌防臭吸汗船袜夏季薄款透气运动低帮',
        priceSum: Math.floor(count*39.9*1000)/1000,
        count: count,
        price: 39.9,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i3/45159296/O1CN01fQiyrJ2IXcYwiGBCb_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type:'袜子',
    }
    function add() {
        setCount(count + 1)
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i3/45159296/O1CN01fQiyrJ2IXcYwiGBCb_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>花花公子袜子男士短袜纯棉抗菌防臭吸汗船袜夏季薄款透气运动低帮</h2>
