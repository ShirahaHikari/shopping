...
const Sock3 = () => {
    ...
    let userShop = {
        ...
        item: '男士加长筒商务袜子男竹纤维长袜男防臭袜黑色高筒袜正装长筒袜男',
        priceSum: Math.floor(count*59*1000)/1000,
        count: count,
        price: 59,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i4/97369832/O1CN017vV2Ov2MV6pKIuCg0_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type:'袜子',
    }
    function add() {
        setCount(count + 1)
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i4/97369832/O1CN017vV2Ov2MV6pKIuCg0_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>男士加长筒商务袜子男竹纤维长袜男防臭袜黑色高筒袜正装长筒袜男</h2>
