...
const Seafood7 = () => {
    ...
    let userShop = {
        ...
        item: '碳烤虾干即食500g大号对虾零食解馋孕妇小吃网红海鲜干货特产美食',
        priceSum: Math.floor(count * 35.8 * 1000) / 1000,
        count: count,
        price: 35.8,
        img: 'https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/2210572455365/O1CN01hj7nCj1pVDe6KguP4_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type: '海鲜',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 35.8 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/2210572455365/O1CN01hj7nCj1pVDe6KguP4_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>碳烤虾干即食500g大号对虾零食解馋孕妇小吃网红海鲜干货特产美食</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥35.80</span>
                    </div>
