...
const Seafood3 = () => {
    ...
    let userShop = {
        ...
        item: '黑虎虾超大新鲜大虾老虎虾鲜活虎虾基围虾特大速冻海鲜竹九节虾',
        priceSum: Math.floor(count * 119 * 1000) / 1000,
        count: count,
        price: 119,
        img: 'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i4/132122162/O1CN01am0tQd1RqF2kU9tlm_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type: '海鲜',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 119 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i4/132122162/O1CN01am0tQd1RqF2kU9tlm_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>黑虎虾超大新鲜大虾老虎虾鲜活虎虾基围虾特大速冻海鲜竹九节虾</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥119.00</span>
                    </div>
