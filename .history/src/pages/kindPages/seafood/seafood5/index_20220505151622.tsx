...
const Seafood5 = () => {
    ...
    let userShop = {
        ...
        item: '北极虾甜虾冰虾海鲜水产大虾鲜活冷冻头籽腹籽带籽5斤刺身北极熊',
        priceSum: Math.floor(count * 129 * 1000) / 1000,
        count: count,
        price: 129,
        img: 'https://g-search3.alicdn.com/img/bao/uploaded/i4/i4/3842101262/O1CN01p6kkgZ1LC2ac8VShj_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type: '海鲜',
    }
    function add() {
        setCount(count + 1)
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i4/3842101262/O1CN01p6kkgZ1LC2ac8VShj_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>北极虾甜虾冰虾海鲜水产大虾鲜活冷冻头籽腹籽带籽5斤刺身北极熊</h2>
