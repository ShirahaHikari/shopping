...
const Seafood4 = () => {
    ...
    let userShop = {
        ...
        item: '新鲜大虾鲜活超大基围虾青岛海虾特大青虾速冻海鲜水产冷冻鲜虾类',
        priceSum: Math.floor(count * 58.8 * 1000) / 1000,
        count: count,
        price: 58.8,
        img: 'https://g-search3.alicdn.com/img/bao/uploaded/i4/i2/3499860862/O1CN012Zphri1IEq9zYYrtD_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type: '海鲜',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 58.8 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i2/3499860862/O1CN012Zphri1IEq9zYYrtD_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>新鲜大虾鲜活超大基围虾青岛海虾特大青虾速冻海鲜水产冷冻鲜虾类</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥58.80</span>
                    </div>
