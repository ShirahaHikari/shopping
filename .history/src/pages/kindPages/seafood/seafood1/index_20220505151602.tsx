...
const Seafood1 = () => {
    ...
    let userShop = {
        ...
        item: '潮汕生腌海鲜虾小海虾醉对虾生腌活虾腌制即食水产灌装呛虾熟食',
        priceSum: Math.floor(count * 39.95 * 1000) / 1000,
        count: count,
        price: 39.95,
        img: 'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i1/18979014/O1CN01ou0ltc2GSStFjJqOC_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type: '海鲜',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 39.95 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i1/18979014/O1CN01ou0ltc2GSStFjJqOC_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>潮汕生腌海鲜虾小海虾醉对虾生腌活虾腌制即食水产灌装呛虾熟食</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥39.95</span>
                    </div>
