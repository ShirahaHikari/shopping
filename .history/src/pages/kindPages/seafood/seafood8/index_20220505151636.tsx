...
const Seafood8 = () => {
    ...
    let userShop = {
        ...
        item: '三文鱼中段新鲜即食刺身拼盘生鱼片海鲜优选辅食婴幼儿冰鲜三文鱼',
        priceSum: Math.floor(count * 98 * 1000) / 1000,
        count: count,
        price: 98,
        img: 'https://picasso.alicdn.com/imgextra/O1CNA1IP64xh2JrbTaPZHBX_!!2201408579475-0-psf.jpg_580x580Q90.jpg_.webp',
        type: '海鲜',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 98 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://picasso.alicdn.com/imgextra/O1CNA1IP64xh2JrbTaPZHBX_!!2201408579475-0-psf.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>三文鱼中段新鲜即食刺身拼盘生鱼片海鲜优选辅食婴幼儿冰鲜三文鱼</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥98.00</span>
                    </div>
