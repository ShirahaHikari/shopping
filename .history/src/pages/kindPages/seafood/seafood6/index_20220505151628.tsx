...
const Seafood6 = () => {
    ...
    let userShop = {
        ...
        item: '鲜有汇聚挪威新鲜三文鱼中段刺身新鲜生鱼片即食海鲜辅食三文鱼肉',
        priceSum: Math.floor(count * 149.9 * 1000) / 1000,
        count: count,
        price: 149.9,
        img: 'https://g-search1.alicdn.com/img/bao/uploaded/i4/i1/2001113363/O1CN013j8tnO1aiIirMuzWp_!!2001113363.jpg_580x580Q90.jpg_.webp',
        type: '海鲜',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 149.9 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/i1/2001113363/O1CN013j8tnO1aiIirMuzWp_!!2001113363.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>鲜有汇聚挪威新鲜三文鱼中段刺身新鲜生鱼片即食海鲜辅食三文鱼肉</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥149.90</span>
                    </div>
