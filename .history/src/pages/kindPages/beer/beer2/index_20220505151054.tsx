...
const Beer2 = () => {
    ...
    let userShop = {
        ...
        item: 'KIRIN日本麒麟啤酒一番榨500ml*24易拉罐装整箱包邮生啤黄啤酒花',
        priceSum: Math.floor(count*179*1000)/1000,
        count: count,
        price: 179,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i1/113521231/O1CN01XuDmP71KxqJHV6PJW_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type:'啤酒',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*179*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i1/113521231/O1CN01XuDmP71KxqJHV6PJW_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>KIRIN日本麒麟啤酒一番榨500ml*24易拉罐装整箱包邮生啤黄啤酒花</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥179.00</span>
                    </div>
