...
const Beer5 = () => {
    ...
    let userShop = {
        ...
        item: '大红乌苏国产啤酒500ml*24罐大乌苏新疆啤酒整箱嘉士伯官方次日达',
        priceSum: Math.floor(count*159*1000)/1000,
        count: count,
        price: 159,
        img:'https://g-search3.alicdn.com/img/bao/uploaded/i4/i2/6000000004609/O1CN01Tps8F31juyDnNnnu2_!!6000000004609-0-picassoopen.jpg_580x580Q90.jpg_.webp',
        type:'啤酒',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*159*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            <div>
                <div className={styles.menu} id='top'>
                    <Menu mode="horizontal" selectedKeys={['food']}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i2/6000000004609/O1CN01Tps8F31juyDnNnnu2_!!6000000004609-0-picassoopen.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>大红乌苏国产啤酒500ml*24罐大乌苏新疆啤酒整箱嘉士伯官方次日达</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥159.00</span>
                    </div>
