...
const Beer7 = () => {
    ...
    let userShop = {
        ...
        item: 'Budweiser/百威啤酒经典醇正450ml*20罐整箱家庭聚会红大罐官方',
        priceSum: Math.floor(count*129*1000)/1000,
        count: count,
        price: 129,
        img:'https://g-search2.alicdn.com/img/bao/uploaded/i4/i4/2508879272/O1CN01Gdwi9P2IMd4ZAM9xD_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type:'啤酒',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*129*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search2.alicdn.com/img/bao/uploaded/i4/i4/2508879272/O1CN01Gdwi9P2IMd4ZAM9xD_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>Budweiser/百威啤酒经典醇正450ml*20罐整箱家庭聚会红大罐官方</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥129.00</span>
                    </div>
