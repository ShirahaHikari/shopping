...
const Beer3 = () => {
    ...
    let userShop = {
        ...
        item: '啤酒定制刻字易拉罐生日礼物送男朋友老公结婚纪念日创意礼品2021',
        priceSum: Math.floor(count*59*1000)/1000,
        count: count,
        price: 59,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i2/13025822/O1CN01iebdWp1ssWYQ4DRFV_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type:'啤酒',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*59*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i2/13025822/O1CN01iebdWp1ssWYQ4DRFV_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>啤酒定制刻字易拉罐生日礼物送男朋友老公结婚纪念日创意礼品2021</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥59.00</span>
                    </div>
