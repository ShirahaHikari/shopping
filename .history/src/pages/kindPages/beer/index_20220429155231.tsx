        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '1500px' }}>
            ...
            <div className={styles.mainPage} id='top'>
                <div className={styles.guessYouLikeItems}>
                    ...
                    <div style={{ position: 'relative', width: '300px', height: '350px' }}>
                        <a href="beer/bear5"><img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i2/6000000004609/O1CN01Tps8F31juyDnNnnu2_!!6000000004609-0-picassoopen.jpg_580x580Q90.jpg_.webp' alt="" style={{ width: '250px', height: '250px', position: 'absolute', right: '0px', borderRadius: '20px' }} /></a>
                        <a href="beer/bear5"><span style={{ position: 'absolute', bottom: '50px', width: '250px', right: '0px', overflow: 'hidden', height: '40px' }}>大红乌苏国产啤酒500ml*24罐大乌苏新疆啤酒整箱嘉士伯官方次日达</span></a>
