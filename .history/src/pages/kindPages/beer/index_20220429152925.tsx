            ...
            <div className={styles.mainPage} id='top'>
                <div className={styles.guessYouLikeItems}>
                    ...
                    <div style={{ position: 'relative', width: '300px', height: '350px' }}>
                        ...
                        <a href="computer/desktop"><span style={{ position: 'absolute', bottom: '50px', width: '250px', right: '0px', overflow: 'hidden', height: '40px' }}>Budweiser/百威啤酒经典醇正450ml*20罐整箱家庭聚会红大罐官方</span></a>
                        <p style={{ position: 'absolute', bottom: '0px', color: 'red', fontSize: '20px', left: '44px' }}>￥129.00</p>
                    </div>
                    <div style={{ position: 'relative', width: '300px', height: '350px' }}>
                        <a href="computer/desktop"><img src='https://g-search2.alicdn.com/img/bao/uploaded/i4/i3/3234779232/O1CN01A0Z3q02I4JELV3740_!!3234779232.jpg_580x580Q90.jpg_.webp' alt="" style={{ width: '250px', height: '250px', position: 'absolute', right: '0px', borderRadius: '20px' }} /></a>
                        <a href="computer/desktop"><span style={{ position: 'absolute', bottom: '50px', width: '250px', right: '0px', overflow: 'hidden', height: '40px' }}>Hoegaarden福佳白啤酒比利时风味小麦白啤酒500ml*18听罐装啤酒</span></a>
