...
const Beer1 = () => {
    ...
    let userShop = {
        ...
        item: '青岛啤酒经典1903啤酒500ml*18听',
        priceSum: Math.floor(count * 109 * 1000) / 1000,
        count: count,
        price: 109,
        img: 'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i1/44080405/O1CN011ErWrvwE35FlvCv_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type: '啤酒',
    }
    function add() {
        setCount(count + 1)
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i1/44080405/O1CN011ErWrvwE35FlvCv_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>青岛啤酒经典1903啤酒500ml*18听</h2>
