...
const Beer4 = () => {
    ...
    let userShop = {
        ...
        item: '1664白啤酒500ml*12罐果味啤酒整箱罐装嘉士伯',
        priceSum: Math.floor(count*139*1000)/1000,
        count: count,
        price: 139,
        img:'https://g-search3.alicdn.com/img/bao/uploaded/i4/i4/6000000003755/O1CN01EDd3W81dbpyiYAJwm_!!6000000003755-0-picassoopen.jpg_580x580Q90.jpg_.webp',
        type:'啤酒',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*139*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i4/6000000003755/O1CN01EDd3W81dbpyiYAJwm_!!6000000003755-0-picassoopen.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>1664白啤酒500ml*12罐果味啤酒整箱罐装嘉士伯</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥139.00</span>
                    </div>
