...
const Jacket7 = () => {
    ...
    let userShop = {
        ...
        item: 'BEASTER小恶魔笑脸短袖T恤潮牌情侣装夏装宽松潮流纯棉短袖上衣男',
        priceSum: Math.floor(count * 229 * 1000) / 1000,
        count: count,
        price: 229,
        img: 'https://g-search3.alicdn.com/img/bao/uploaded/i4/i4/3173651031/O1CN01hwQjXt1JUF64Rj2Kk_!!3173651031.jpg_580x580Q90.jpg_.webp',
        type: '上衣',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 229 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            <div>
                <div className={styles.menu} id='top'>
                    <Menu mode="horizontal" selectedKeys={['clothes']}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i4/3173651031/O1CN01hwQjXt1JUF64Rj2Kk_!!3173651031.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>BEASTER小恶魔笑脸短袖T恤潮牌情侣装夏装宽松潮流纯棉短袖上衣男</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥229.00</span>
                    </div>
