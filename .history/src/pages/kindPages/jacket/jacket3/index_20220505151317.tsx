...
const Jacket3 = () => {
    ...
    let userShop = {
        ...
        count: count,
        price: 179,
        img:'https://g-search3.alicdn.com/img/bao/uploaded/i4/i3/669642169/O1CN01VpJXVh1RtRowlTmLW-669642169.jpg_580x580Q90.jpg_.webp',
        type:'上衣',
    }
    function add() {
        setCount(count + 1)
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i3/669642169/O1CN01VpJXVh1RtRowlTmLW-669642169.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
