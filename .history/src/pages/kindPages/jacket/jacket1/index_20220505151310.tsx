...
const Jacket1 = () => {
    ...
    let userShop = {
        ...
        item: 'BONELESS基础后背坐标印花短袖T恤男美式高街潮牌圆领上衣',
        priceSum: Math.floor(count * 149 * 1000) / 1000,
        count: count,
        price: 149,
        img: 'https://picasso.alicdn.com/imgextra/O1CNA1Dt6K9H1QOvoWfl81K_!!2208161521967-0-psf.jpg_580x580Q90.jpg_.webp',
        type: '上衣',
    }
    function add() {
        setCount(count + 1)
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://picasso.alicdn.com/imgextra/O1CNA1Dt6K9H1QOvoWfl81K_!!2208161521967-0-psf.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>BONELESS基础后背坐标印花短袖T恤男美式高街潮牌圆领上衣</h2>
