...
const Jacket4 = () => {
    ...
    let userShop = {
        ...
        item: '714street重磅t恤男情侣短袖潮牌新款宽松体恤男士纯棉打底衫上衣',
        priceSum: Math.floor(count * 139 * 1000) / 1000,
        count: count,
        price: 139,
        img: 'https://g-search2.alicdn.com/img/bao/uploaded/i4/i1/2200972470090/O1CN012PUZVE1CXGOisblLa_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type: '上衣',
    }
    function add() {
        setCount(count + 1)
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search2.alicdn.com/img/bao/uploaded/i4/i1/2200972470090/O1CN012PUZVE1CXGOisblLa_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>714street重磅t恤男情侣短袖潮牌新款宽松体恤男士纯棉打底衫上衣</h2>
