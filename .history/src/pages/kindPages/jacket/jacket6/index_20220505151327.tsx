...
const Jacket6 = () => {
    ...
    let userShop = {
        ...
        item: '何穗同款伊芙丽衬衫女2022夏新小众v领泡泡袖法式衬衣白色小上衣',
        priceSum: Math.floor(count * 399 * 1000) / 1000,
        count: count,
        price: 399,
        img: 'https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/641725918/O1CN01R7dDDl1taUfggdj9G_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type: '上衣',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 399 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/641725918/O1CN01R7dDDl1taUfggdj9G_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>何穗同款伊芙丽衬衫女2022夏新小众v领泡泡袖法式衬衣白色小上衣</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥399.00</span>
                    </div>
