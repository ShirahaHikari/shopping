...
const Jacket2 = () => {
    ...
    let userShop = {
        ...
        item: '【亲肤】Gap男女装LOGO纯棉短袖T恤688537 2022夏季情侣休闲上衣',
        priceSum: Math.floor(count * 179 * 1000) / 1000,
        count: count,
        price: 179,
        img: 'https://g-search2.alicdn.com/img/bao/uploaded/i4/i3/669642169/O1CN01Pqg24C1RtRomSkF5v-669642169.jpg_580x580Q90.jpg_.webp',
        type: '上衣',
    }
    function add() {
        setCount(count + 1)
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search2.alicdn.com/img/bao/uploaded/i4/i3/669642169/O1CN01Pqg24C1RtRomSkF5v-669642169.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>【亲肤】Gap男女装LOGO纯棉短袖T恤688537 2022夏季情侣休闲上衣</h2>
