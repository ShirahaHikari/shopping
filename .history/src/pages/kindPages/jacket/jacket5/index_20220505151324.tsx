...
const Jacket5 = () => {
    ...
    let userShop = {
        ...
        item: '【三丽鸥联名】乐町t恤蓝色玉桂大耳狗可爱上衣夏季新款短袖T恤女',
        priceSum: Math.floor(count * 166 * 1000) / 1000,
        count: count,
        price: 166,
        img: 'https://g-search2.alicdn.com/img/bao/uploaded/i4/i2/513051429/O1CN011IvATt1MQWjGbbvZu_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type: '上衣',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 166 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search2.alicdn.com/img/bao/uploaded/i4/i2/513051429/O1CN011IvATt1MQWjGbbvZu_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>【三丽鸥联名】乐町t恤蓝色玉桂大耳狗可爱上衣夏季新款短袖T恤女</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥166.00</span>
                    </div>
