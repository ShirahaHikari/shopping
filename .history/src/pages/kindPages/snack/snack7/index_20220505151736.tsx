...
const Snack7 = () => {
    ...
    let userShop = {
        ...
        item: '【孙俪同款】妙可蓝多儿童零食健康营养高钙奶酪棒500g25支',
        priceSum: Math.floor(count*74*1000)/1000,
        count: count,
        price: 74,
        img:'https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/3321924298/O1CN01C1Q1AX1hcX2j3KStI_!!3321924298.jpg_580x580Q90.jpg_.webp',
        type:'零食',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*74*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i1/3321924298/O1CN01C1Q1AX1hcX2j3KStI_!!3321924298.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>【孙俪同款】妙可蓝多儿童零食健康营养高钙奶酪棒500g25支</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥74.00</span>
                    </div>
