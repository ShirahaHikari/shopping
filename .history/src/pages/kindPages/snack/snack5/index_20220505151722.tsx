...
const Snack5 = () => {
    ...
    let userShop = {
        ...
        item: '良品铺子每日坚果礼盒30包小包装健康混合干果零食大礼包孕妇新鲜',
        priceSum: Math.floor(count*138*1000)/1000,
        count: count,
        price: 138,
        img:'https://g-search3.alicdn.com/img/bao/uploaded/i4/i4/619123122/O1CN01MMIAsz1YvvGjaaCjd-619123122.jpg_580x580Q90.jpg_.webp',
        type:'零食',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*138*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i4/619123122/O1CN01MMIAsz1YvvGjaaCjd-619123122.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>良品铺子每日坚果礼盒30包小包装健康混合干果零食大礼包孕妇新鲜</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥138.00</span>
                    </div>
