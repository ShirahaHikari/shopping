...
const Snack3 = () => {
    ...
    let userShop = {
        ...
        item: '百草味零食大礼包肉食类充饥夜宵一整箱超大巨型包网红爆款送女友',
        priceSum: Math.floor(count*89*1000)/1000,
        count: count,
        price: 89,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i4/131476552/O1CN01sCKUqL1yGrkxw6nFm_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type:'零食',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*89*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i4/131476552/O1CN01sCKUqL1yGrkxw6nFm_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>百草味零食大礼包肉食类充饥夜宵一整箱超大巨型包网红爆款送女友</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥89.00</span>
                    </div>
