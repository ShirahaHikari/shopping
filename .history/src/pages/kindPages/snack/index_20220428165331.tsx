        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '1500px' }}>
            ...
            <div className={styles.mainPage} id='top'>
                <div className={styles.guessYouLikeItems}>
                    ...
                    <div style={{ position: 'relative', width: '300px', height: '350px' }}>
                        <a href="food/desktop"><img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i3/28808769/O1CN01b2VxpV2EeFqcEfQB1_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' alt="" style={{ width: '250px', height: '250px', position: 'absolute', right: '0px', borderRadius: '20px' }} /></a>
                        <a href="food/desktop" className={styles.crossOver}><span style={{ position: 'absolute', bottom: '50px', width: '250px', right: '0px', overflow: 'hidden', height: '40px' }}>然硕 酷睿i5 10400F/12400F/华硕RTX3050独显台式电脑主机高配吃鸡电竞游戏DIY组装机直播设计师办公整机全套</span></a>
                        <p style={{ position: 'absolute', bottom: '0px', color: 'red', fontSize: '20px', left: '44px' }}>￥2399.00</p>
                    </div>
                    <div style={{ position: 'relative', width: '300px', height: '350px' }}>
                        <a href="food/desktop"><img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i1/114749949/O1CN01O5j7sn2NMhCMCrwEF_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' alt="" style={{ width: '250px', height: '250px', position: 'absolute', right: '0px', borderRadius: '20px' }} /></a>
                        <a href="food/desktop"><span style={{ position: 'absolute', bottom: '50px', width: '250px', right: '0px', overflow: 'hidden', height: '40px' }}>酷耶 英特尔酷睿i5/i7四核商务办公电脑赛扬双核 台式电脑主机组装机整机台式机税控迷你主机</span></a>
                        <p style={{ position: 'absolute', bottom: '0px', color: 'red', fontSize: '20px', left: '44px' }}>￥998.00</p>
                    </div>
                    <div style={{ position: 'relative', width: '300px', height: '350px' }}>
                        <a href="food/desktop"><img src='https://g-search3.alicdn.com/img/bao/uploaded/i4/i3/126446588/O1CN015qCZl11yXM29QDPR6_!!0-item_pic.jpg_580x580Q90.jpg_.webp' alt="" style={{ width: '250px', height: '250px', position: 'absolute', right: '0px', borderRadius: '20px' }} /></a>
                        <a href="food/desktop"><span style={{ position: 'absolute', bottom: '50px', width: '250px', right: '0px', overflow: 'hidden', height: '40px' }}>【网课一体机】联想一体机AIO520 21.5/23.8/27英寸一体机台式电脑一体机家用学习办公台式机网课一体机电脑</span></a>
                    ...
                    <div style={{ position: 'relative', width: '300px', height: '350px' }}>
                        ...
                        <a href="food/desktop"><span style={{ position: 'absolute', bottom: '50px', width: '250px', right: '0px', overflow: 'hidden', height: '40px' }}>【24期免息】ALIENWARE外星人全新Aurora R12台式机11代酷睿i7游戏电竞电脑主机3070整机高端官方旗舰店台机</span></a>
