...
const Snack4 = () => {
    ...
    let userShop = {
        ...
        item: '江中猴姑饼干酥性20天装养胃囤货猴头菇饼干猴菇食品上班族小零食',
        priceSum: Math.floor(count*139*1000)/1000,
        count: count,
        price: 139,
        img:'https://g-search2.alicdn.com/img/bao/uploaded/i4/i3/2012793042/O1CN01xCJMCu1YLHaKzcwuI_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type:'零食',
    }
    function add() {
        setCount(count + 1)
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search2.alicdn.com/img/bao/uploaded/i4/i3/2012793042/O1CN01xCJMCu1YLHaKzcwuI_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>江中猴姑饼干酥性20天装养胃囤货猴头菇饼干猴菇食品上班族小零食</h2>
