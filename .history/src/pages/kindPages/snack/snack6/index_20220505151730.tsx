...
const Snack6 = () => {
    ...
    let userShop = {
        ...
        item: '天虹牌混合果仁2斤大罐装1kg每日坚果杂果综合果干孕妇儿童零食',
        priceSum: Math.floor(count*169.9*1000)/1000,
        count: count,
        price: 169.9,
        img:'https://g-search2.alicdn.com/img/bao/uploaded/i4/i1/2137401477/O1CN01TPlaNm1MmVk3l1L94_!!2137401477.jpg_580x580Q90.jpg_.webp',
        type:'零食',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*169.9*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search2.alicdn.com/img/bao/uploaded/i4/i1/2137401477/O1CN01TPlaNm1MmVk3l1L94_!!2137401477.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>天虹牌混合果仁2斤大罐装1kg每日坚果杂果综合果干孕妇儿童零食</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥169.90</span>
                    </div>
