...
const Snack2 = () => {
    ...
    let userShop = {
        ...
        item: '悠之优味五级孤独冷吃火锅虎皮凤爪500g卤味香辣味零食虎皮鸡爪',
        priceSum: Math.floor(count*18.8*1000)/1000,
        count: count,
        price: 18.8,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i2/99743790/O1CN01UdvTIQ1drrpsHLO0f_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type:'零食',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count*18.8*1000)/1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i2/99743790/O1CN01UdvTIQ1drrpsHLO0f_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>悠之优味五级孤独冷吃火锅虎皮凤爪500g卤味香辣味零食虎皮鸡爪</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥18.80</span>
                    </div>
