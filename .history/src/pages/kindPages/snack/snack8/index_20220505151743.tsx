...
const Snack8 = () => {
    ...
    let userShop = {
        ...
        item: '沃隆每日坚果混合坚果休闲零食大礼包营养干果仁独立小包装750g',
        priceSum: Math.floor(count*139*1000)/1000,
        count: count,
        price: 139,
        img:'https://g-search1.alicdn.com/img/bao/uploaded/i4/i4/2745562235/O1CN01C5H2Vn1SNfxXO2pM0_!!0-item_pic.jpg_580x580Q90.jpg_.webp',
        type:'零食',
    }
    function add() {
        setCount(count + 1)
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/i4/2745562235/O1CN01C5H2Vn1SNfxXO2pM0_!!0-item_pic.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>沃隆每日坚果混合坚果休闲零食大礼包营养干果仁独立小包装750g</h2>
