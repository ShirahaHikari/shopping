...
const Snack1 = () => {
    ...
    let userShop = {
        ...
        item: '零食大礼包小吃休闲食品整箱小送女友网红爆款猪饲料高端肉食香辣',
        priceSum: Math.floor(count * 59.9 * 1000) / 1000,
        count: count,
        price: 59.9,
        img: 'https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i1/541900029/O1CN01K87lnW1C5K2sLu5Hs_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp',
        type: '零食',
    }
    function add() {
        setCount(count + 1)
    ...
    function buy() {
        Modal.confirm({
            title: `确定要直接购买吗,价格${Math.floor(count * 59.9 * 1000) / 1000}元`,
            content: '',
            okText: '确认',
            cancelText: '取消',
            onOk: () => {
        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '600px' }}>
            ...
            <div className={styles.itemDetail}>
                <div className={styles.picLeft}>
                    <img src='https://g-search1.alicdn.com/img/bao/uploaded/i4/imgextra/i1/541900029/O1CN01K87lnW1C5K2sLu5Hs_!!0-saturn_solar.jpg_580x580Q90.jpg_.webp' style={{ width: 300, height: 300 }} alt="" />
                </div>
                <div className={styles.wordRight}>
                    <h2 style={{ marginTop: 30 }}>零食大礼包小吃休闲食品整箱小送女友网红爆款猪饲料高端肉食香辣</h2>
                    <div style={{ backgroundColor: 'rgb(255,242,232' }}>
                        <span>价格   </span>
                        <span style={{ color: 'rgb(255,68,0)', fontSize: '30px', marginLeft: 23, fontWeight: 'bold' }}>￥59.90</span>
                    </div>
