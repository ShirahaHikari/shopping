    ...
    render() {
        return (
            <div style={{ width: '100%', height: '1000px' }}>
                ...
                {(this.state.userAdviseForm && <div>
                    <div>用户评论列表</div>
                    <Table columns={this.state.columnsAdvise} dataSource={this.state.userAdvise}></Table>
                </div>)
                }
                {(this.state.buyRecordFlag && <div>
                    <div>用户购买记录</div>
                    <Table columns={this.state.columnsBuyRecord} dataSource={this.state.userBuyRecord}></Table>
                </div>)}
