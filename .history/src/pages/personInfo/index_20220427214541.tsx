                                ...
                                if (tmp.status === 200) {
                                    ...
                                    axios.post('http://localhost:3000/addUserBuyRecord', params).then((res1) => {
                                        if (res1.status === 200) {
                                            ...
                                            axios.post('http://localhost:3000/getUserBuyRecord,params').then((res3)=>{
                                                if(res3.status === 200){
    ...
    render() {
        return (
            <div style={{ width: '100%', height: '1000px' }}>
                ...
                {(this.state.buyRecordFlag && <Table columns={this.state.columnsBuyRecord} dataSource={this.state.userBuyRecord}></Table>)}
            </div >
        )
    }
}
