    ...
    return (
        <div style={{ width: 1400 }} >
            ...
            <div className={styles.autoFather}>
                <Carousel autoplay>
                    <div><a href=""><img src={require('../../imgs/adv1.jpg')} alt="" /></a></div>
                    <div><a href=""><img src={require('../../imgs/adv2.jpg')} alt="" /></a></div>
                    <div><a href=""><img src={require('../../imgs/adv3.jpg')} alt="" /></a></div>
                </Carousel>
            </div>
        </div>
    )
