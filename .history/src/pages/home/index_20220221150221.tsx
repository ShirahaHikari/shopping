            ...
            <div className={styles.mainPage}>
                ...
                <div className={styles.guessYouLikeItems}>
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
                        ...
                        <span style={{position:'absolute', bottom:'50px',width:'250px',right:'0px',fontSize:'20px'}}>心相印纸巾抽纸整箱大包家用实惠装卫生纸心心相印餐巾纸面巾纸抽</span>
                        <p style={{position:'absolute',bottom:'0px',color:'red',fontSize:'20px',}}>9.9</p>
                    </div>
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
                        <img src={require('../../imgs/toiletPaper.webp')} alt=""  style={{width:'250px',height:'250px',position:'absolute',right:'0px',borderRadius:'20px'}}/>
                        <span style={{position:'absolute', bottom:'50px',width:'250px',right:'0px'}}>心相印纸巾抽纸整箱大包家用实惠装卫生纸心心相印餐巾纸面巾纸抽</span>
                    </div>
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
                        <img src={require('../../imgs/toiletPaper.webp')} alt=""  style={{width:'250px',height:'250px',position:'absolute',right:'0px',borderRadius:'20px'}}/>
                        <span style={{position:'absolute', bottom:'50px',width:'250px',right:'0px'}}>心相印纸巾抽纸整箱大包家用实惠装卫生纸心心相印餐巾纸面巾纸抽</span>
