            ...
            <div className={styles.mainPage}>
                ...
                <div className={styles.guessYouLikeItems}>
                    ...
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
                        ...
                        <p style={{position:'absolute',bottom:'0px',color:'red',fontSize:'20px',left:'44px'}}>￥8.8</p>
                    </div>
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
                    ...
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
                        ...
                        <p style={{position:'absolute',bottom:'0px',color:'red',fontSize:'20px',left:'44px'}}>￥9.8</p>
                    </div>
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
