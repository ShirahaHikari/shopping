        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '3000px' }}>
            ...
            <div className={styles.mainPage}>
                <div className={styles.border}>
                    ...
                    <img src="https://img.alicdn.com/imgextra/i1/1771842251/O1CN01EyxKib1SV0HyIVj7q_!!1771842251-0-alimamacc.jpg_400x400q90.jpg_.webp" style={{width:'300px',height:'280px',marginTop: '80px', marginLeft: '20px'}} alt="" />
