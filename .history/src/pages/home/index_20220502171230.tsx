            ...
            <div className={styles.mainPage} id='top'>
                <div className={styles.border}>
                    <div className={styles.autoFather}>
                        <Carousel autoplay>
                            <a className={styles.autoPlay} href="/clothes/jacket" ><img src='https://gtms03.alicdn.com/tps/i3/TB1gXd1JXXXXXapXpXXvKyzTVXX-520-280.jpg' alt="" /></a>
                            <a className={styles.autoPlay} href="/food/snack" ><img src={require('../../imgs/adv2.jpg')} alt="" /></a>
                            <a className={styles.autoPlay} href="#" ><img src='https://img.alicdn.com/imgextra/i1/1716150173/O1CN01nGXTN51D9HH2zF3RP_!!0-saturn_solar.jpg_270x270.jpg' alt="" /></a>
                        </Carousel>
                    </div>
                    <a href="/likeItems/massageChair"><img src="https://img.alicdn.com/imgextra/i1/1771842251/O1CN01EyxKib1SV0HyIVj7q_!!1771842251-0-alimamacc.jpg_400x400q90.jpg_.webp" style={{ width: '300px', height: '280px', marginTop: '80px', marginLeft: '20px', borderRadius: '20px' }} alt="" /></a>
                    <a href="/computer/notebook"><img src={require('../../imgs/adv5.jpg')} style={{ width: '300px', height: '280px', marginTop: '80px', marginLeft: '20px', borderRadius: '20px' }} alt="" /></a>
                </div>
