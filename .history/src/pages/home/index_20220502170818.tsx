        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%', height: '3000px' }}>
            ...
            <div className={styles.mainPage} id='top'>
                <div className={styles.border}>
                    ...
                    <a href="/computer/notebook" target='_blank'><img src={require('../../imgs/adv5.jpg')} style={{ width: '300px', height: '280px', marginTop: '80px', marginLeft: '20px', borderRadius: '20px' }} alt="" /></a>
                </div>
