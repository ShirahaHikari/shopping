        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%' ,height:'2000px'}}>
            ...
            <div className={styles.mainPage}>
                ...
                <div className={styles.guessYouLikeItems}>
                    <div style={{position:'relative', backgroundColor:'red',width:'300px',height:'300px'}}>
                        <img src={require('../../imgs/toiletPaper.webp')} alt=""  style={{width:'250px',height:'250px',position:'absolute'}}/>
                        <span style={{position:'absolute', bottom:'2px',width:'250px'}}>心相印纸巾抽纸整箱大包家用实惠装卫生纸心心相印餐巾纸面巾纸抽</span>
                    </div>
                    <div style={{position:'relative', backgroundColor:'red',width:'300px',height:'300px'}}>
                        <img src={require('../../imgs/toiletPaper.webp')} alt=""  style={{width:'250px',height:'250px',position:'absolute'}}/>
                        <span style={{position:'absolute', bottom:'2px',width:'250px'}}>心相印纸巾抽纸整箱大包家用实惠装卫生纸心心相印餐巾纸面巾纸抽</span>
                    ...
                    <div style={{position:'relative', backgroundColor:'red',width:'300px',height:'300px'}}>
                        <img src={require('../../imgs/toiletPaper.webp')} alt=""  style={{width:'250px',height:'250px',position:'absolute',right:'0px'}}/>
                        <span style={{position:'absolute', bottom:'2px',width:'250px',right:'0px'}}>心相印纸巾抽纸整箱大包家用实惠装卫生纸心心相印餐巾纸面巾纸抽</span>
                    </div>
                    <div style={{position:'relative', backgroundColor:'red',width:'300px',height:'300px'}}>
                        <img src={require('../../imgs/toiletPaper.webp')} alt=""  style={{width:'250px',height:'250px',position:'absolute'}}/>
                        <span style={{position:'absolute', bottom:'2px',width:'250px'}}>心相印纸巾抽纸整箱大包家用实惠装卫生纸心心相印餐巾纸面巾纸抽</span>
