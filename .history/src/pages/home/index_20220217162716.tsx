            ...
            <div className={styles.mainPage}>
                <div className={styles.border}>
                    ...
                    <div className={styles.rightText}>
                        <span style={{ font: 'bond', fontSize: 16 }}>公告</span>
                        <span style={{ marginLeft: '10px' }}>新鲜的事都在这哦~</span>
                        <br />
                        <a href="https://www.bilibili.com/video/BV15t411U7yf?share_source=copy_web">flutter的学习教程</a>
                        <br />
                        <a href="https://www.bilibili.com/video/BV1JU4y1E73v?share_source=copy_web">ReactHooks的学习教程</a>
                    </div>
                </div>
            </div>
        </div>
