        ...
        <div style={{ backgroundColor: 'rgb(234,232,235)', width: '100%' ,height:'3000px'}}>
            ...
            <div className={styles.mainPage}>
                ...
                <div className={styles.guessYouLikeItems}>
                    ...
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
                        <a href="likeItems/earPhone"><img src={require('../../imgs/earPhone.webp')} alt=""  style={{width:'250px',height:'250px',position:'absolute',right:'0px',borderRadius:'20px'}}/></a>
                    ...
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
                        <a href="likeItems/clothWashes"><img src={require('../../imgs/clothWashes.webp')} alt=""  style={{width:'250px',height:'250px',position:'absolute',right:'0px',borderRadius:'20px'}}/></a>
                    ...
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
                        <a href="likeItems/dress"><img src={require('../../imgs/dress.webp')} alt=""  style={{width:'250px',height:'250px',position:'absolute',right:'0px',borderRadius:'20px'}}/></a>
                    ...
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
                        <a href="likeItems/blackPants"><img src={require('../../imgs/blackPants.webp')} alt=""  style={{width:'250px',height:'250px',position:'absolute',right:'0px',borderRadius:'20px'}}/></a>
                    ...
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
                        <a href="likeItems/massageChair"><img src={require('../../imgs/massageChair.webp')} alt=""  style={{width:'250px',height:'250px',position:'absolute',right:'0px',borderRadius:'20px'}}/></a>
                    ...
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
                        <a href="likeItems/japaneseNotebook"><img src={require('../../imgs/japaneseNotebook.webp')} alt=""  style={{width:'250px',height:'250px',position:'absolute',right:'0px',borderRadius:'20px'}}/></a>
                    ...
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
                        <a href="likeItems/baseballHat"><img src={require('../../imgs/baseballHat.webp')} alt=""  style={{width:'250px',height:'250px',position:'absolute',right:'0px',borderRadius:'20px'}}/></a>
                        <a href="likeItems/baseballHat"><span style={{position:'absolute', bottom:'50px',width:'250px',right:'0px'}}>ZARA棒球帽女咖啡色R标显瘦显脸小百搭纯棉帽子男韩版ins鸭舌帽潮</span></a>
                    ...
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
                        <a href="likeItems/runMachine"><img src={require('../../imgs/runMachine.webp')} alt=""  style={{width:'250px',height:'250px',position:'absolute',right:'0px',borderRadius:'20px'}}/></a>
                    ...
                    <div style={{position:'relative',width:'300px',height:'350px'}}>
                        <a href="likeItems/jordanShoe"><img src={require('../../imgs/jordanShoe.webp')} alt=""  style={{width:'250px',height:'250px',position:'absolute',right:'0px',borderRadius:'20px'}}/></a>
