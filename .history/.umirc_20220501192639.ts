...
export default defineConfig({
  ...
  routes: [
    ...
    { path: '/clothes/socks/sock1', component: '@/pages/kindPages/sock/sock2'},//分类 袜子2
    { path: '/clothes/socks/sock1', component: '@/pages/kindPages/sock/sock3'},//分类 袜子3
    { path: '/clothes/socks/sock1', component: '@/pages/kindPages/sock/sock4'},//分类 袜子4
    { path: '/clothes/socks/sock1', component: '@/pages/kindPages/sock/sock5'},//分类 袜子5
    { path: '/clothes/socks/sock1', component: '@/pages/kindPages/sock/sock6'},//分类 袜子6
    { path: '/clothes/socks/sock1', component: '@/pages/kindPages/sock/sock7'},//分类 袜子7
    { path: '/clothes/socks/sock1', component: '@/pages/kindPages/sock/sock8'},//分类 袜子8
  ],
  fastRefresh: {},
  proxy:{
    '/api':{
